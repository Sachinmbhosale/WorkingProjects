<%@ Page Title="" Language="C#" MasterPageFile="~/Workflow/WorkflowMaster/WorkflowAdmin.Master"
    AutoEventWireup="true" CodeBehind="Workflow1_DetailReport.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.WorkflowAdmin.Workflow1_DetailReport" %>
            ...
            <tr>
                ...
                <td class="auto-style1" colspan="2">
                    <asp:Button ID="btnGenerate" runat="server" Text="Generate Report" TagName="Read" OnClientClick="return ValidateSearch();"
                       CssClass="btngeneratereport" OnClick="btnGenerate_Click" style="display:none" />
