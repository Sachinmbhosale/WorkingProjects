<%@ Page Title="" Language="C#" MasterPageFile="~/Workflow/WorkflowMaster/WorkflowAdmin.Master"
    AutoEventWireup="true" CodeBehind="WorkflowViewstatus.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.WorkflowAdmin.WorkflowViewstatus" %>
        ...
        <ContentTemplate>
            ...
            <div class="GVDiv">
                ...
                <asp:Panel ID="ButtonPanel" runat="server" >
                 <asp:Button ID="btnGotoDataEntry" runat="server" Text="View" OnClick="btnGotoDataEntry_Click"
