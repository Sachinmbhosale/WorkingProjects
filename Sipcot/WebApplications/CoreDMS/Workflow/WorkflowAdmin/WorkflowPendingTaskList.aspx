<%@ Page Title="" Language="C#" MasterPageFile="~/Workflow/WorkflowMaster/WorkflowAdmin.Master"
    AutoEventWireup="true" CodeBehind="WorkflowPendingTaskList.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.WorkflowAdmin.WorkflowPendingTaskList" %>
                ...
                <asp:GridView ID="GridPendingList" runat="server" AutoGenerateColumns="true" DataKeyNames="Id#"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Select">
                            <ItemTemplate>
                                <asp:RadioButton ID="RowTaskSelector" TagName="Read" runat="server" OnClick="javascript:SelectSingleRadiobutton(this)" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
