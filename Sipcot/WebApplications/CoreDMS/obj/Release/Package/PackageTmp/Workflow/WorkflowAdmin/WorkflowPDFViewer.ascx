<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowPDFViewer.ascx.cs"
    Inherits="WorkflowPdfViewer.WorkflowPDFViewer" %>
...
<asp:Panel ID="MainPanel" runat="server" Height="100%" Width="700px" Wrap="False">
                ...
                <asp:TableCell ID="ImageControls_Part1" runat="server">
                    <asp:Table ID="ToolStripTable" runat="server" CellPadding="5" Height="40px">
                     ...
                     <a id="PreviousPage" href="#" title="PreviousPage" onclick="navigationHandler('PREVIOUS'); return false;"><img src="../../AnnotaionImages/backward.png" alt="Delete" /></a>
                            ...
                            <asp:TableCell ID="TableCell25" runat="server" VerticalAlign="Middle" HorizontalAlign="Center">
                                <%--<asp:DropDownList ID="ddlpagecount" runat="server" onchange="">
                                </asp:DropDownList>--%>
                            </asp:TableCell>
                            <asp:TableCell ID="TableCell23" runat="server" VerticalAlign="Middle" HorizontalAlign="Center">
                                    <a id="NextPage" href="#" title="NextPage" onclick="navigationHandler('NEXT'); return false;">
                                        <img src="../../AnnotaionImages/Forward.png" alt="Delete" /></a>
                            </asp:TableCell>
                            <asp:TableCell ID="zoomViewerSelect" runat="server" VerticalAlign="Middle" HorizontalAlign="Center">
                                    <select id="zoomSelect" class="controlsSelect" onchange="zoomViewer(); return false;">
