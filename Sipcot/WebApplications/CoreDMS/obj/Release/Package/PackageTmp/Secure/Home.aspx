...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="CenterBaseDiv">
            ...
            <tr>
                <td>
                    <div style="text-align: center; width: 1225px;">
                        ...
                        <span style="font-weight:bolder;font-size:14px">Document Management System</span>
                        <hr />
                    </div>
                </td>
            </tr>
        ...
        <br />
        <br />
        <table class="style1" border="0" cellpadding="0" cellspacing="0" style="color:#808080">
            <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <asp:Label ID="lblUserName" runat="server" CssClass="LabelStyle"></asp:Label>
                                    <%--<asp:Label
