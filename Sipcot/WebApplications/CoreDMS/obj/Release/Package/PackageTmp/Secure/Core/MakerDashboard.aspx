<%@ Page Title="" Language="C#" MasterPageFile="~/SecureMaster.Master" AutoEventWireup="true"
    CodeBehind="MakerDashboard.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Secure.Core.MakerDashboard" %>
                                    ...
                                    <td colspan="4">
                                        <div id="divdrops">
                                            <asp:Panel ID="pnlIndexpro" runat="server">
                                                ...
                                                <br />
                                                <asp:Button ID="btnAddQuery" runat="server" class="btnadd" Width="100px" meta:resourcekey="btnAddQuery"
                                                    OnClick="AddQuery" OnClientClick="return SetPageIndex(1);" Text="New / Clear" ToolTip="New or clear query" />
                                                        ...
                                                        <table border="0" cellpadding="3" cellspacing="3" class="style1">
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    ...
                                                                    <asp:Button ID="btnSaveQuery" runat="Server" meta:resourcekey="btnSaveQuery" OnClick="btnSaveQueryClick" class="btnsave" Width="100px"
                                                                        Text="Save Query" />
                                                                </td>
                                                            </tr>
        ...
        function Redirect(ProcessID, DocId, DepID, Active, PageNo, MainTagId, SubTagId, SlicingStatus) {
            ...
            if (true) {//parseInt(info.acrobatVersion, 10) > 10) {
                if (SlicingStatus == 'Uploaded') {
                    window.location.href = "DocumentDownloadDetails.aspx?id=" + ProcessID + '&docid=' + DocId + '&depid=' + DepID + '&active=' + Active + '&PageNo=' + PageNo + '&MainTagId=' + MainTagId + '&SubTagId=' + SubTagId + '&Search=' + document.getElementById("<%=hdnSearchString.ClientID %>").value + '&Page=MakerDashboard';
                }
                else {
