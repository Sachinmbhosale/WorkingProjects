...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="GVDiv">
        ...
        <asp:Button ID="btnNextDoc" runat="server" OnClick="btnNextDoc_Click" ToolTip="Next Document" TagName="Next Document" Text="Next Document" CssClass="nxtprev" Style="display: none" />
        <asp:Button ID="btnPrevDoc" runat="server" TagName="Previous Document" Text="Previous Document" OnClick="btnPrevDoc_Click" CssClass="nxtprev" Style="display: none" />
        ...
        <asp:Button ID="btnCancel" CssClass="btnsearchagain"
            runat="server" Text="Search Again" OnClick="btnCancel_Click" TagName="Read" Style="display: none" />
        ...
        <table cellpadding="3" cellspacing="3">
            ...
            <tr>
                ...
                Font-Bold="True"></asp:Label>
                                <asp:DropDownList ID="ddlPDAdd" AutoPostBack="false" runat="server" Visible="false">
                                </asp:DropDownList>
                                Enter selected page :
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox2" runat="server" TextMode="SingleLine" Width="70px"></asp:TextBox>
                                <asp:Button ID="btnDownloadSelected" CssClass="image-button document-download" runat="server"
                                    Text="" ToolTip="Download Selected Pages" TagName="Download" OnClick="btnDownloadSelected_Click" Style="height: 10px" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <div class="DivInlineBlockPage">
                                    ...
                                    <asp:Button ID="btnDownload" CssClass="image-button document-download" runat="server" style="display:none"
                                    ...
                                    <asp:Button ID="btnDownloadWithAnn" CssClass="image-button document-download-with-annotation"
                                        runat="server"  style="display:none" ToolTip="Download document with annotations" TagName="Download Annotated"
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                        <ContentTemplate>
                                            <asp:Button ID="btnHistory" runat="server" CssClass="image-button document-History"
                                                ToolTip="History" OnClientClick="return Redirect_History();" TagName="Delete" Style="display: none"  />
                                            <asp:Button ID="btnprint" runat="server" style="display:none" CssClass="image-button document-print" ToolTip="Print"
                                    ...
                                    <%--  <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                                        ...
                                        .... Sachin ......
                                    --%>
                                    <iframe runat="server" id="pdfFrame1" src="" height="650" width="900" scrolling="auto"
                                        style="border-width: 0px;" />
                                    <uc1:PDFViewer ID="PDFViewer1" runat="server" Visible="False" />
                                    <%-- </ContentTemplate
                                    </asp:UpdatePanel>--%>
