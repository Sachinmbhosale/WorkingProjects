...
<asp:Content ID="Content2" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //function add for sell all multiple user  add by nasir


        function ToggleUserSelection() {
            var selectObject = document.getElementById("<%= drpUser.ClientID %>");
            var isSelected = selectObject.options[0].selected;
            var checkObj = document.getElementById("<%= chkSelectAllUser.ClientID %>");
        ...
        // function add for list user

        function getSelectValues() {
            var select = document.getElementById("<%= drpUser.ClientID %>");
            var result = [];
            var Status;
        ...
        function validateuser() {
            ...
            if (document.getElementById("<%= drpOrg.ClientID  %>").value == "0") {
                ...
                var date1 = fromDate
                var date2 = throughDate


                var t2 = new Date(date1);
                var t1 = new Date(date2);

                var finaldate =    (t1 - t2) / (24 * 3600 * 1000);

               

<%--                if (finaldate.value > 185) {

                    
                    var radiobutton = document.getElementById("<%= RdoPeriod.ClientID  %>").value;



                    ctl00_ContentPlaceHolder2_ContentPlaceHolder1_RdoPeriod_2
        ...
        function searchfilter(Type) {
            ...
            if (Type == 'USER' && chkuser.checked == true) {
                ...
                document.getElementById("<%= drpUser.ClientID  %>").disabled = false;
                ...
                document.getElementById("<%= drpUser.ClientID  %>").disabled = true;
                                        ...
                                        <asp:UpdatePanel ID="DocumentPanel" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                            <ContentTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbldoc" runat="server" CssClass="LabelStyle" Text="Doc. Name"></asp:Label>
                                                        <br />
                                                        <br />
                                                        <asp:Label ID="lbltext" runat="server" CssClass="LabelStyle" Text="User Search"></asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:CheckBox ID="chkSelectAllUser" style="display:none" runat="server" Text="Select All" CssClass="RadioButtonStlye" />
                                                        <br />
                                                        <asp:ListBox ID="drpUser"    runat="server" SelectionMode="Multiple"></asp:ListBox>

                                                        <asp:DropDownList ID="ddlusername"  style="display:none" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlusername_SelectedIndexChanged">
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server" CssClass="LabelStyle" Text="Error Types"></asp:Label>
                                                        <%--<asp:Label ID="Label5" runat="server" CssClass="LabelStyle" Text="Project Type"></asp:Label>--%>
                                                    </td>
                                                    <td>
                                                        <asp:DropDownList ID="cmbDocType" runat="server">
                                                            <asp:ListItem Value="Critical,Non-Critical">&lt;Select&gt;</asp:ListItem>
                                                            <asp:ListItem Value="Critical">Critical</asp:ListItem>
                                                            <asp:ListItem Value="Non-Critical">Non-Critical</asp:ListItem>
