<%@ Page Title="" Language="C#" MasterPageFile="~/SecureMaster.Master" AutoEventWireup="true"
    CodeBehind="DocumentDownloadDetails_2.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Secure.Core.DocumentDownloadDetails_2"
...
<asp:Content ID="Content2" ContentPlaceHolderID="Head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function RestrictCommaSemicolon(e) {
            ...
            document.getElementById("<%= err.ClientID %>").in = ' ';
            //var regex = /[^,;]+$/;
            var regex = /[^A-Za-z;./;:'"{}!@#$%&()]+$/;
            if (!regex.test(key)) {
                        ...
                        <asp:Panel ID="TagPanel" runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtpageNo" runat="server" onkeypress="return RestrictCommaSemicolon(event);"></asp:TextBox>
                                    <br />
                                    <asp:Label ID="err" runat="server" Text="" ForeColor="Red" Font-Size="X-Small"></asp:Label>
                                    <%--<asp:RegularExpressionValidator ID="validatorp" ControlToValidate="txtpageNo"
ValidationExpression="[0-9]+(,[0-9]+)*" EnableClientScript="true"
ErrorMessage="Invalid number" runat="server" />--%>
                        ...
                        <tr>
                            <td>
                                <div class="DivInlineBlockPage">
                                    ...
                                    <iframe runat="server" id="Ifullpdf" src="" height="650" width="900" scrolling="auto"
                                        style="border-width: 0px;"  />
