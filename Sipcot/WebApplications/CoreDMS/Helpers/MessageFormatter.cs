...
public class MessageFormatter : Control
{
    ...
    public static string GetFormattedMessage(string message, MessageType messageType = MessageType.Notice)
    {
        switch (messageType)
        {
            case MessageType.Success: return "<div class=\"alert alert-success\"> Success:<strong></strong>" + " " + message + "</div>";
            case MessageType.Error: return "<div class=\"alert alert-error\"><strong>Error:</strong>" + " " + message + "</div>";
            default: return "<div class=\"alert alert-info\"><strong>Notice:</strong>" + " " + message + "</div>";
        }
    }
}