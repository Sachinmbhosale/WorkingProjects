...
{
    public partial class MainTagSubTagReport : PageBase
    {
        ...
        protected void lnkbtnExport_Click(object sender, EventArgs e)
        {
            ...
            //{
                pBindData(null, true);
                ///export to excel
                pExportGridToExcel(grdView, "MainTagSubTag_" + Convert.ToString(DateTime.Now) + ".xls");
            //}
        }
        ...
        private void pBindData(string aSortExp, bool aIsCompleteData)
        {
            ...
            try
            {
                ...
                grdView.DataBind();
                //string s = Session["orgid"].ToString();
                //filter.DocumentTypeID = Convert.ToInt32(cmbDocumentType.SelectedValue);
                //filter.DepartmentID = Convert.ToInt32(cmbDepartment.SelectedValue);
                //filter.CurrOrgId = Convert.ToInt32(Session["orgid"].ToString());
                ...
                string action = "";
                ds = bl.ReportDocumentTagWise(filter, action, hdnLoginOrgId.Value.ToString(), hdnLoginToken.Value.ToString());
        ...
        private void pExportGridToExcel(GridView grdGridView, String fileName)
        {
            ...
            string headerTable = @"<Table cellspacing='0' cellpadding='0' rules='all' border='1'><tr><td><b>" + loginUser.LoginOrgName.ToString() + "</b></td><td></td><td></td><td></td></tr><tr><td><b>Report Type : </b></td><td>Main Tag Sub Tag Report</td><td></td><td></td></tr><tr><td><b>From Date : </b></td><td>" + txtCreatedDateFrom.Text + "</td><td><b>To Date : </b></td><td>" + txtCreatedDateTo.Text + "</td></tr></Table>";
