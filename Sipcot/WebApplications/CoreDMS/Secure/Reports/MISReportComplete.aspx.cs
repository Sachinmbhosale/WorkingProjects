...
{
    public partial class MISReportComplete : PageBase
    {
        ...
        private void pBindData(string aSortExp, bool aIsCompleteData)
        {
            ...
            try
            {
                ...
                if (txtCreatedDateFrom.Text.Trim() == "")
                {
                    filter.StartDate = "1000-01-01";                
                }
                else
                {
                    filter.StartDate = txtCreatedDateFrom.Text.Trim();
                }
                if (txtCreatedDateTo.Text.Trim()=="")
                {
                    filter.EndDate = DateTime.Today.ToString("yyyy-MM-dd");
                }
                else
                {
        ...
        private void pExportGridToExcel(GridView grdGridView, String fileName)
        {
            ...
            string headerTable = @"<Table cellspacing='0' cellpadding='0' rules='all' border='1'><tr><td><b>" + loginUser.LoginOrgName.ToString() + "</b></td><td></td><td></td><td></td></tr><tr><td><b>Project Type : </b></td><td>" + cmbDocumentType.SelectedItem.Text + "</td><td><b>Department : </b></td><td>" + cmbDepartment.SelectedItem.Text + "</td><td></td><td></td></tr><tr><td><b>Report Type : </b></td><td>Mis Report</td><td></td><td></td></tr><tr><td><b>From Date : </b></td><td>" + txtCreatedDateFrom.Text + "</td><td><b>To Date : </b></td><td>" + txtCreatedDateTo.Text + "</td></tr></Table>";
