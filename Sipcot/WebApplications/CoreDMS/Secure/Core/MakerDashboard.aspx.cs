...
{
    public partial class MakerDashboard : PageBase
    {
        ...
        protected void btnPerformQueryClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                results = bl.SearchDocumentsForMakerChecker(filter, SearchAction, hdnLoginOrgId.Value, hdnLoginToken.Value,"Maker");
        ...
        private void CreateQueryClause(string ObjectType, DataRow dr, int controlId)
        {
            ...
            ddlBoolOperator.CssClass = "ComboStyle";
            ...
            ddlQueryCondition.CssClass = "ComboStyle";
            ...
            ddlFieldNames.CssClass = "ComboStyle";
            ...
            ddlFieldValue.CssClass = "ComboStyle";
            ...
            txtFieldValue.CssClass = "TextBoxStyle";
        ...
        void BindQueries()
        {
            ...
            try
            {
                ...
                ds = objQueryBL.GetQueriesByUserName(Convert.ToInt32(cmbDocumentType.SelectedValue),Convert.ToInt32(hdnLoginOrgId.Value),hdnLoginToken.Value.ToString());
