    ...
    public partial class Dashboard : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string txtCreatedDateFrom1 =  Convert.ToString(txtCreatedDateFrom.Text);
                string txrcreatedateto = Convert.ToString(txtCreatedDateTo.Text);

                if (!String.IsNullOrEmpty(txtCreatedDateFrom1) && !String.IsNullOrEmpty(txrcreatedateto) )
                {
                    dsChar = objTChartData.GetDashboardTotalCount_WithDateFilter(iOrgId, Convert.ToDateTime(txtCreatedDateFrom.Text), Convert.ToDateTime(txtCreatedDateTo.Text));
                }
                ...
                Logger.TraceErrorLog(ltChartData.Text);
                ...
                Logger.TraceErrorLog("Line 147 in dashboard.aspx");
        ...
        protected void btnShowGarph_Click(object sender, EventArgs e)
        {
            UserBase loginUser = (UserBase)Session["LoggedUser"];
            int iOrgId = loginUser.LoginOrgId;
            if (loginUser.IsDomainUser == true)
            ...
            //  ltChartData.Text = "<script>chartDept = " + deptName + ";" + "chart_No_Of_Doc=" + No_of_doc + ";chart_page_Counts=" + Page_Count + ";</script>";
            //ltChartData.Text = "<script>chartDept = " + deptName + ";" + "chart_No_Of_Doc=" + No_of_doc + ";" + "chart_page_Counts=" + Page_Count + ";" + "DeptName=" + DeptName + ";" + "DeptCount=" + DeptCount + ";" + "</script>";
            //ltChartData.Text = "<script>chartDept = " + deptName + ";"
            //                            + "chart_No_Of_Doc=" + No_of_doc + ";" +
            //                            "chart_page_Counts=" + Page_Count + ";" +
            //                             "DeptName=" + DeptName + ";" +
            //                            "DeptCount=" + DeptCount + ";" +
            //                            "</script>";
        ...
        public DataSet GetDashboardTotalCount()
        {
            DataSet dsChartData = new DataSet();
            try
            {
        ...
        //            LegendItem lgItem = new LegendItem();
        //            lgItem.Name = "File Count";
        //            lgItem.BorderWidth = 2;
        //            lgItem.ShadowOffset = 1;
        //            lgItem.Color = Color.DarkMagenta; 
        //            lgItem.BorderColor= Color.DarkMagenta;
        //            chrtOverall.Legends["CountLegend"].CustomItems.Add(lgItem);

        //            LegendItem lgItems = new LegendItem();
        //            lgItems.Name = "Page Count";
        //            lgItems.BorderWidth = 2;
        //            lgItems.ShadowOffset = 1;
        //            lgItems.Color = Color.YellowGreen;
        //            lgItems.BorderColor = Color.YellowGreen;                   
        //            chrtOverall.Legends["CountLegend"].CustomItems.Add(lgItems);
        ...
        //private string Bindchart_Grid(string sProjType, string sDepttype, string DeptName)
        //{
        //    try
        //    {
        //        DashboardBAL objDash = new DashboardBAL();
        ...
        //                    if (dr["Data"].ToString()!= "Total Pages")
        //                    {
        //                        series.Points.AddXY(dr["Data"].ToString(), y);
        //                    }
        //                    else
        //                    {
        //                        series.Points.AddXY(DeptName, y);
        //                    }
        ...
        ////}
        //added by prathamesh for chart data
