<%@ Page Title="" Language="C#" MasterPageFile="~/SecureMaster.Master" AutoEventWireup="true"
    CodeBehind="DocumentDownloadGlobalSearch.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Secure.Core.DocumentDownloadGlobalSearch" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1_BS" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div style="height: 188px; width: 350px; overflow-y: scroll">
                                                ...
                                                <center>
                                                    <div id="divSearchResults_BS">
                                                        <asp:GridView ID="GridView1" runat="server"
                                                            ...
                                                            CssClass="mGrid" AllowSorting="True" OnRowCreated="GridView1_RowCreated" >
