<%@ Page Title="" Language="C#" MasterPageFile="~/SecureMaster.Master" AutoEventWireup="true" CodeBehind="FullDocumentSearch.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Secure.Core.FullDocumentSearch" %>
                    ...
                    <asp:TabPanel ID="NormalSearch" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="DivInlineBlock">
                                ...
                                <br />
                                <br />
                                &nbsp;<asp:Button ID="btndownloadall" runat="server" Text="Download Invoices" class="btnadd" OnClick="Download" Width="150px" Visible="false" />
                                        ...
                                        <tr>
                                            <td height="8">
                                                ...
                                                <div id="Div1" style="overflow: auto" runat="server">
                                                    <asp:GridView ID="GridView1" runat="server" CssClass="mGrid" Width="400px" PageSize="10" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="View" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <a href='DocumentDownloadDetails.aspx?<%# Eval("View") %>'>
                                                                        <img border='0' src='../../Assets/Skin/Images/view.png' alt='view' />
                                                                    </a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <%--<asp:BoundField HeaderText="Invoice" DataField="UPLOAD_vFld1">
