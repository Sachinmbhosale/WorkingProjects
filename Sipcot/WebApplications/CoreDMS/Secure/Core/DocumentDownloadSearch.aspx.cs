    ...
    public partial class DocumentDownloadSearch : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["Login"] == "Load")
                {
        ...
        protected void btnPerformQueryClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string text = filter.WhereClause;
                ...
                if (text.Contains("%"))
                {
                    ...
                    whereclause = "DocumentOCR_tOCRContent like " + "'%" + result[0].ToString() + "%'" + " OR DocumentOCR_tOCRContent like " + "'%" + result[1].ToString() + "%'";
                    filter.WhereClause = whereclause;
                }
                else
                {
                    whereclause = "DocumentOCR_tOCRContent like " + "'%" + filter.WhereClause.ToString() + "%'";
                    filter.WhereClause = whereclause;
                }
        ...
        public void BindDocumentType(string loginOrgId, string loginToken)
        {
            ...
            try
            {
                ...
                cmbDocumentType_SelectedIndexChanged(null, null);
            }
            catch (Exception ex)
            {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Concanetquery = string.Empty;
                foreach (DataRow row in dsColumn.Rows)
                {
                    ...
                    Concanetquery = Concanetquery + row["Field_Name"].ToString() + "[" + row["Col_Name"].ToString() + "]" + ",";
                }
                Concanetquery = Concanetquery.Substring(0, Concanetquery.Length - 1);

                DataTable dsGetTepcolumns = null;
                dsGetTepcolumns = BL.GetTempcolumns(SearchData, Concanetquery);
                if (dsGetTepcolumns.Rows.Count > 0)
                {
                    Session["ExporttoExcel"] = dsGetTepcolumns;


                    GridView1.AllowSorting = true;
                    // GridView1.AutoGenerateColumns = false;
                    GridView1.DataSource = dsGetTepcolumns;
                ...
                {
                   // lblTotalFileCount.Text = Convert.ToString(dsSearcData.Rows.Count);
                    btnExcelDownload.Visible = true;

                    Session["TaskTable"] = dsGetTepcolumns;
                    ...
                    ////BoundField gFieldDwload = new BoundField();
                    ////gFieldDwload.HeaderText = "Download";
                    ////gFieldDwload.DataField = "UPLOAD_vDocPhysicalPath";
                    ////GridView1.Columns.Add(gFieldDwload);

                    //BoundField gFieldSrNo = new BoundField();
                    //gFieldSrNo.HeaderText = "Sr No";
                    //gFieldSrNo.DataField = "SrNo";
                    //GridView1.Columns.Add(gFieldSrNo);
                    ...
                    //ghiField3.SortExpression = "True";
                    //ghiField3.HeaderText = "Total Pages";
                    //ghiField3.DataField = "TotalPages";
                    //ghiField3.SortExpression = "TotalPages";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var bookPrice = (HiddenField)e.Row.FindControl("Hidview");
                string strdview = bookPrice.Value;

                //HiddenField Hidview = (e.Row.FindControl("Hidview") as HiddenField);
                ...
                {
                    hlControtag.NavigateUrl = "~/Secure/Core/DocumentDownloadDetails.aspx?" + strdview.Replace("$", "&");
                ...
                //hlControtag.Enabled = e.Row.Cells[3].Text.Trim() == "F" ? true : false;
                e.Row.Cells[0].Controls.Add(hlControtag);
                e.Row.Cells[0].Controls.Add(hlControEdittag);
            ...
            //    //image.ImageUrl = "~/Assets/Skin/Images/Download.png";
            ...
            //            //hlDownload.NavigateUrl = "~/Secure/Core/DocumentDownloadDetails.aspx?" + e.Row.Cells[0].Text.Replace("$", "&") + SearchField;
            //            //ImgDownload.ID = "BtnDownload";                       
            //            //ImgDownload.ImageUrl = "~/Assets/Skin/Images/Download.png";
            //            //ImgDownload.ToolTip = "Download";
            //            //ImgDownload.CommandName = "FileDownload";
        ...
        protected void btnGlobalsearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GridView1.Columns.Clear();
                    lbltotalrowcount.Text = "Total Records count :  " + Convert.ToString(dsSearcData.Rows.Count);
        ...
        {
            //  int sortColumnIndex = GetSortedColumnIndex(GridView1.Rows[0], e.SortExpression);
        ...
        protected int GetSortedColumnIndex(GridViewRow row, string sortExpression)
        {
            int HeaderCellIndex = 0;
            for (int i = 0; i < row.Cells.Count; i++)
            {
                BoundField boundField = (BoundField)((DataControlFieldCell)row.Cells[i]).ContainingField;
                if (boundField.DataField == sortExpression)
                {
                    HeaderCellIndex = i;
                    break;
                }
        ...
        protected void btnExcelDownload_Click(object sender, ImageClickEventArgs e)
        {
            if (Session["TaskTable"] != null)
            {
                DataTable searchResult = Session["ExporttoExcel"] as DataTable;

                ExportToExcel(searchResult);
        ...
        {
            string filename = cmbDepartment_BS.SelectedItem.Text+ ".xls";
            string ExpExcelpath = System.Configuration.ConfigurationManager.AppSettings["SearchExcel"];

            string sPath = ExpExcelpath + "\\" + filename;
            StreamWriter wr = new StreamWriter(sPath);
            try
            {
            ...
            Response.Redirect("ExporttoExcel.ashx?path=" + sPath + "&Orgfilename=" + filename);
            ...
            //  {
            //      Response.Write("<td>" + clmn.ColumnName.ToString() + "</td>");
            //  }
            //  Response.Write("</tr>");
            //  Response.Write("</thead>");
            ...
            ////  string Temppath1 = System.Configuration.ConfigurationManager.AppSettings["tmp"];
            //  //string sPath = Temppath1 + "\\Tempzip_" + userid + ".zip";
            ...
            //        Response.Write(str.ToString().Replace(HttpUtility.HtmlDecode("&nbsp;"), " "));
            //        str = "\t";
            //    }
            //    Response.Write("\n");
            //}
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                string at = Convert.ToString(e.CommandArgument.ToString());
            }
        }
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                {
                    HiddenField Hidview = (HiddenField)row.FindControl("Hidview");
                    HiddenField Hiddownload = (HiddenField)row.FindControl("Hiddownload");
                    string strdview = Hidview.Value;
                    string strdownload = Hiddownload.Value;
                    ImageButton hlControtag = (ImageButton)row.FindControl("ImageButton2");
                    hlControtag.PostBackUrl = "~/Secure/Core/DocumentDownloadDetails.aspx?" + strdview.Replace("$", "&");
                    hlControtag.ToolTip = "View Document";
                    hlControtag.OnClientClick = "target='blank'";
        ...
        {
            GridViewRow grdrow = (GridViewRow)((ImageButton)sender).NamingContainer;
            string filePath = grdrow.Cells[3].Text; //process id
            string Orgfilename = grdrow.Cells[6].Text; //process id
            

            Response.Redirect("PDFDownloader.ashx?filePath=" + filePath + "&Orgfilename=" + Orgfilename);



            //Response.ContentType = "application/octet-stream";
            //Response.AppendHeader("Content-Disposition", "attachment;filename=" + "Doc.pdf");
            //Response.TransmitFile(documentId);
            //Response.End();

            // Response.Redirect("PDFDownload.ashx?path=" + documentId);

            //// GridViewRow grdrow = (GridViewRow)((ImageButton)sender).NamingContainer;
            //// string documentId = grdrow.Cells[3].Text; //process id
            ...
            //// string OriginalFilePath = documentId;
            //// // File Name
            //// string FileName = Path.GetFileNameWithoutExtension(documentId);
            //// // File Extension
            //// string FileExtension = Path.GetExtension(documentId);
            ...
            //// Response.Redirect("PDFDownload.ashx?path=" + OriginalFilePath);
