<%@ Page Title="" Language="C#" MasterPageFile="~/SecureMaster.Master" AutoEventWireup="true"
    CodeBehind="MultipleDocumentDownloadSearch.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Secure.Core.MultipleDocumentDownloadSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validateInput() {
            ...
            var email = $("input[myid='txtMail'")[1].value;
            //alert(email);
        ...
        function SearchDocuments_BS() {
            // for download button
            $("#<%= btndownloadall.ClientID %>").attr('disabled', false);
            $("#<%= btnSendEmail.ClientID %>").attr('disabled', false);
            //download button code ends here...
            ...
            if (ValidateInputData_BS(msgControl, "SearchDocuments_BS")) {
                ...
                document.getElementById("<%=hdnSearchString.ClientID %>").value = WhereClause;
                if (RedirectRequired != 'Yes') { //DMS04-3406M
                    //return CallPostScalar(msgControl, "SearchDocuments", params);
                    $("#<%=btnSearchNew.ClientID %>").click();
                }
                else {
        ...
        function removeLoader() {
            $("#statusPopup img:last-child").remove()
        }
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lblCurrentPath" runat="server" CssClass="CurrentPath" Text="Home  &gt; Multiple Document Download Search"></asp:Label>
                    ...
                    <asp:TabPanel ID="NormalSearch" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="DivInlineBlock">
                                <asp:UpdatePanel ID="UpdatePanel1_BS" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblIndexProprties_BS" runat="server" CssClass="LabelStyle" Text="Index Properties"><span>Index Properties</span><br /><span style="font-weight:normal;font-size:10px;color:#f00"> (multiple invoices can be search by adding ',' between invoices)</span></asp:Label>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <div style="height: 188px; width: 500px; overflow-y: scroll">
                                                        <asp:UpdatePanel ID="Indexupdatepanel_BS" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    ...
                                                    <input type="button" id="Search_BS" value="Search" class="btnsearch" onclick="SearchDocuments_BS();"
                                                        tagname="Read" />
                                                    <asp:Button ID="btnSearchNew" runat="server" Text="Search" class="btnsearch" OnClick="SearchNew" style="display: none" />

                                                    <input type="button" id="btnDigtialSignature" value="Digital Signature" class="DigitalSign"
                                                        onclick="Redirect_D();" tagname="Read" />
                                ...
                                <br />
                                <br />
                                &nbsp;<asp:Button ID="btndownloadall" runat="server" Text="Download Files" OnClientClick="removeLoader()" class="btnadd" OnClick="Download" Width="150px" Visible="False" />
                                <asp:Label ID="emptyinv" runat="server"></asp:Label>
                                <br /><br />
                                <asp:Button ID="btnSendEmail" runat="server"
                                    ToolTip="Email" OnClientClick="return ShowMD();" Text="Send Email" class="btnemail" Visible="false"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="mailres" runat="server" style="color:#f00"></asp:Label>
                            </div>
                            <div class="DivInlineBlock">
                                            ...
                                            <td height="8">
                                                <div id="paging_BS" style="visibility: hidden;">
                                                    <a>Rows per page
                                                        ...
                                                        ssss<asp:HiddenField ID="hdnSortOrder_BS" runat="server" />
                                                        <asp:HiddenField ID="hdnTotalRowCount_BS" runat="server" />
                                                        <asp:HiddenField ID="hdnRowsPerPage_BS" Value="1000000000" runat="server" />
                                                ...
                                                <div style="overflow: auto" runat="server">
                                                    <asp:GridView ID="GridView1" runat="server" PageSize="10" CssClass="mGrid" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                            ...
                            <div id="dialog" title="Basic dialog" style="display:none">
                                ...
                                <table>
                                    <tr>
                                        <td colspan="2">
                                            <asp:Label ID="lblMesg" runat="server" Visible="False"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtMailTo" runat="server" Width="350px" myid="txtMail" onchange="validateInput()"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="Button3" runat="server" Text="Send Mail" TagName="Share" OnClick="btnSendMail"
                                                CssClass="btnemail"  />
                                            &nbsp;
                                            <input type="button" value="Close" id="closemail" class="btnclose" onclick="HideMD()"/>
                                        </td>
                                    </tr>
                                </table>
                                                                    ...
                                                                    <div id="divdrops">
                                                                        <asp:Panel ID="pnlIndexpro" runat="server">
                                                                            ...
                                                                            <asp:Button ID="btnAddQuery" runat="server" class="btnadd" meta:resourcekey="btnAddQuery"
                                                                                Width="90px" OnClick="AddQuery" Text="New / Clear" ToolTip="New or clear query"
                                                                                OnClientClick="return SetPageIndex(1);" />
                                                                            <asp:Button ID="btnAddClause" Text="Add Clause" meta:resourcekey="btnAddClause" class="btnadd"
                                                                                Width="90px" runat="server" OnClick="btnAddClauseClick" OnClientClick="return SetPageIndex(1);" />
                                                                            <asp:Button ID="btnRemoveClause" Text="Remove Clause" class="removebutton" meta:resourcekey="btnRemoveClause"
                                                                                Width="95px" runat="server" OnClick="btnRemoveClauseClick" OnClientClick="return SetPageIndex(1);" />
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="3">
                                                                                                ...
                                                                                                <asp:Button ID="btnSaveQuery" runat="server" class="btnsave" meta:resourcekey="btnSaveQuery"
                                                                                                    Width="90px" OnClick="btnSaveQueryClick" Text="Save Query" />
                                                                                            </td>
                                                                                        </tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div id="divSearchResultsOuter">
                                                                        <center>
                                                                            <div id="divSearchResults" runat="server" style="width: 550px; overflow: auto; display: none;">
                                                                                sssssssss
                                                                            </div>
                                    ...
                                    <table width="550" border="0" align="center" class="generalBox">
                                        ...
                                        <tr>
                                            <td height="8">
                                                ...
                                                <center>
                                                    <asp:GridView ID="GridOCR" runat="server" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                                        OnRowDataBound="GridOCR_RowDataBound" AlternatingRowStyle-CssClass="alt" EmptyDataText="No records are found">
                                                        <Columns>
