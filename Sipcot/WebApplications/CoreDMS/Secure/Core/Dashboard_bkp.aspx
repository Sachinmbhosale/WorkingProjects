    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                url: "../Services/Chart.asmx/HelloWorld",
                data: "{}",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
                    var data = [];
                    var datavalue = ' <table style="border:1px solid #000000;width:100%;font-family:Verdana;font-size: 70%;background-color:#e0fbfc;">';
                    datavalue += '<tr><td style="border:1px solid #000000;text-align:center;background-color:#93a0f9;font-weight:600">Description</td><td style="border:1px solid #000000;text-align:center;background-color:#93a0f9;font-weight:600">Count</td></tr>';
                    for (var i in Result) {
                        var serie = new Array(Result[i].Label, Result[i].Count);
                        data.push(serie);

                        //if (datavalue == null) {
                        //    datavalue = '<tr><td style="border:1px solid #000000;">' + Result[i].Label + '</td><td style="border:1px solid #000000;">' + Result[i].Count + "</td></tr>";
                        //}
                        //else {
                        datavalue += '<tr><td style="border:1px solid #000000;">' + Result[i].Label + '</td><td style="border:1px solid #000000;text-align:center">' + Result[i].Count + '</td></tr>';
                        //}
