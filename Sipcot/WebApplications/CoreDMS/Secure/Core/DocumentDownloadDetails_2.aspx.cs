...
{
    public partial class DocumentDownloadDetails_2 : PageBase
    {
        ...
        public DataTable getSelectedPages()
        {
            ...
            string[] strPageNo= txtpageNo.Text.Split(',');
        ...
        {
            ListItem item = ddlPDAdd.Items.FindByText(DDLDrop.SelectedValue);
            if (item != null)
            {
                string a = item.Text;
            }
            ...
            {
                ddlPDAdd.Items.Add(DDLDrop.SelectedValue);
            }

            ////    if (ddlPDAdd.Items.Contains(DDLDrop.SelectedValue))
            ////ddlPDAdd.Items.Add(DDLDrop.SelectedValue);
        ...
        private void LoadImageToViewer(string Action)
        {
            try
            {
                ...
                Ifullpdf.Attributes.Add("src", "../../pdf.js/web/viewer.html?f=" + strPdfPath);
        ...
        //        string PdfPath = TempFolder + beforedot(Session["EncyptImgName"].ToString()) + "\\" + PageNo.ToString() + ".pdf";
        //        //for download single page
        //        hdnCurrentPagePath.Value = PdfPath;
        //        //single page download ends here
        ...
        {
            string path = (@"" + hdnCurrentPagePath.Value.ToString() + ""); //get physical file path from server
...

        {
            ...
            if (maxpagenumer <= pagecount)
            {
                ...
                PDFMerging.MergeFilesDownload(DownloadFilepath, TempWorkFolderPath, getSelectedPages(), strPageNo.Length);
                DownloadFile(DownloadFilepath);
                LoadImageToViewer(DDLDrop.SelectedValue.ToString());
            }
            else
