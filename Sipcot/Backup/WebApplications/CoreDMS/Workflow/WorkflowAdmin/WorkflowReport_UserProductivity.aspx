<%@ Page Title="" Language="C#" MasterPageFile="~/Workflow/WorkflowMaster/WorkflowAdmin.Master"
    AutoEventWireup="true" CodeBehind="WorkflowReport_UserProductivity.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.WorkflowAdmin.WorkflowReport_UserProductivity" %>
    ...
    <div class="GVDiv">
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSearch" TagName="Read" runat="server" Text="Generate Report" OnClientClick="return ValidateSearch();"
        ...
        <asp:GridView ID="GridReport" runat="server" AutoGenerateColumns="true" CssClass="mGrid"
            ...
            EmptyDataText="No report is available" PageSize="50" CellPadding="10" CellSpacing="5"
