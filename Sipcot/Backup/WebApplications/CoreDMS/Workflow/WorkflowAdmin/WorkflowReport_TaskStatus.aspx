<%@ Page Title="" Language="C#" MasterPageFile="~/Workflow/WorkflowMaster/WorkflowAdmin.Master"
    AutoEventWireup="true" CodeBehind="WorkflowReport_TaskStatus.aspx.cs" Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.WorkflowAdmin.WorkflowReport_TaskStatus" %>
    ...
    <div class="GVDiv">
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSearch" runat="server" TagName="Read" Text="Generate Report" OnClientClick="return ValidateSearch();"
                        OnClick="btnSearch_Click" CssClass="btngeneratereport" />
                </td>
            </tr>
        </table>
        <asp:GridView ID="GridReport" runat="server" AutoGenerateColumns="true" CssClass="mGrid"
            AllowPaging="true" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
            EmptyDataText="No report is available" CellPadding="10" CellSpacing="5" OnRowDataBound="GridReport_RowDataBound"
            PageSize="50" OnPageIndexChanging="GridReport_PageIndexChanging">
