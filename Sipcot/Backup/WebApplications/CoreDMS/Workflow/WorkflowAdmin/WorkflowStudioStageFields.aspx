<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowStudioStageFields.aspx.cs"
    Inherits="Lotex.EnterpriseSolutions.WebUI.Workflow.DragAndDrop.WorkflowStudioStageFields" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClientClick="return parent.HideFieldsProperties();"
