...
{
    public partial class ExpiryReport : PageBase
    {
        ...
        protected void btnsearchSub_Click(object sender, EventArgs e)
        {
            ...
            //SqlCommand cmdtempdet = new SqlCommand("USP_ExpiryReportFilter", Connect);// have to pass date from there
            ...
            temdet = BL.ExpiryReport(BE, Convert.ToInt32(hdnLoginOrgId.Value), hdnLoginToken.Value);
            ...
            if (temdet.Tables.Count > 0 && temdet.Tables[0].Rows.Count > 0)
            {
                ...
                ReportViewerMain.LocalReport.ReportEmbeddedResource = "ExpiryReport.rdlc";
                ReportDataSource datasource = new ReportDataSource("DataSetExpiryDate", temdet.Tables[0]);
