        ...
        <table>
            ...
            <tr>
                ...
                <fieldset>
                    ...
                    <tr>
                    <td></td>
                     <td> <asp:Label ID="Label1" runat="server" CssClass="LabelStyle" Text="Select Period "></asp:Label>
                            </td>
                    </tr>
                        <tr>
                            <td><asp:Label ID="Label2" runat="server" CssClass="LabelStyle" Text="From"></asp:Label>
                            <td> <asp:TextBox ID="txtCreatedDateFrom" runat="server" ></asp:TextBox>
                    ...
                    <asp:ImageButton ID="btnCalenderStart" runat="server" CssClass="ImageButtonStyle"
                        Height="16px" ImageUrl="~/Images/CalenderImage.png" Width="16px" />
                            ...
                            <td><asp:Label ID="Label3" runat="server" CssClass="LabelStyle" Text="To"></asp:Label>
                            </td> 
                            <td>  <asp:TextBox ID="txtCreatedDateTo" runat="server" ></asp:TextBox>
                    ...
                    <asp:ImageButton ID="btnCalenderTo" runat="server" CssClass="ImageButtonStyle" Height="16px"
                        ...
                        <tr>
                            ...
                            <td>  <asp:Button ID="btnsearchSub" runat="server" Text="Search"  CssClass="btnsearch"
                        OnClick="btnsearchSub_Click" />
                  
                    <asp:Button ID="btnclear" runat="server"  Text="Clear"  CssClass="btnclear"
