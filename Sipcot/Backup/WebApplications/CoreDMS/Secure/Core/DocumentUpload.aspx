    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            for (i = 0; i < parseInt(count); i++) {
                if (EntryType[i] != "Multiple Field Selection") {
                    ...
                    var controlname = 'ctl00_ContentPlaceHolder1_' + IndexNames[i].replace(/\s+/g, '');
                    ...
                    //DMS5-4101M replaced the space with empty string
                    controlname = 'ctl00_ContentPlaceHolder1_' + Controlnames[i].replace(/\s+/g, '');
        ...
        function uploadStart(sender, args) {
            ...
            if (doctype.value != '0' && dept.value != '0') {
                ...
                || filext == 'gif' || filext == 'giff' || filext == 'pdf'
                ) {
                    return true;
                }
                else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblCurrentPath" runat="server" CssClass="CurrentPath" Text="Home  &gt;  Document Upload">
    </asp:Label>
    <div class="GVDiv">
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <table style="width: 425px;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label6" runat="server" CssClass="LabelStyle" Text="Select File to Upload">
                                        </asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtRefid" runat="server" ReadOnly="True" Height="15px" Width="90px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="style3" style="width: auto; height: auto" align="center">
                                                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btnsave" OnClick="btnSave_Click"
                                                        CausesValidation="False" Enabled="False" TagName="Upload" />
