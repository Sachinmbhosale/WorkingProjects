            ...
            <div class="GVDiv">
                <asp:TabContainer runat="Server" ID="Search" ActiveTabIndex="0" CssClass="ajax__myTab"
                    ...
                    <asp:TabPanel ID="AdvancedSearch" runat="server">
                        <HeaderTemplate>
                            Advanced Search</HeaderTemplate>
                        <ContentTemplate>
                            <div id="divResultMsg">
                            </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <div id="divSearchResultsOuter">
                                                                        <center>
                                                                            <div id="divSearchResults" runat="server" style="width: 550px; overflow: auto;">
                                                                                &nbsp;</div>
                                                                        </center>
                                                                    </div>
                                                                </td>
