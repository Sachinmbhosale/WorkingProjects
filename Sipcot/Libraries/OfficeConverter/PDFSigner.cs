...
namespace OfficeConverter
{
    ...
    public class MetaData
    {
        ...
        {
            get { return info["Subject"]; }
            set { info.Add("Subject", value); }
        }
        public string Keywords
        {
            get { return info["Keywords"]; }
            set { info.Add("Keywords", value); }
        }
        public string Producer
        {
            get { return info["Producer"]; }
            set { info.Add("Producer", value); }
        }

        public string Creator
        {
            get { return info["Creator"]; }
    ...
    public class PDFSigner
    {
        ...
        public void Sign(string SigReason, string SigContact, string SigLocation, bool visible)
        {
            ...
            sap.SetCrypto(this.myCert.Akp, this.myCert.Chain, null, PdfSignatureAppearance.WINCER_SIGNED); // Commented
